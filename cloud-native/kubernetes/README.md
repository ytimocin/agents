...
curl -fsSL https://raw.githubusercontent.com/ytimocin/agents/main/cloud-native/kubernetes/claude.md \
...
mkdir -p ~/.codex
curl -fsSL https://raw.githubusercontent.com/ytimocin/agents/main/cloud-native/kubernetes/codex.md \
  -o ~/.codex/AGENTS.md
...
```bash
mkdir -p .github
curl -fsSL https://raw.githubusercontent.com/ytimocin/agents/main/cloud-native/kubernetes/copilot.md \
