...
curl -fsSL https://raw.githubusercontent.com/ytimocin/agents/main/cloud-native/helm/claude.md \
...
mkdir -p ~/.codex
curl -fsSL https://raw.githubusercontent.com/ytimocin/agents/main/cloud-native/helm/codex.md \
  -o ~/.codex/AGENTS.md
...
```bash
mkdir -p .github
curl -fsSL https://raw.githubusercontent.com/ytimocin/agents/main/cloud-native/helm/copilot.md \
