...
curl -fsSL https://raw.githubusercontent.com/ytimocin/agents/main/observability/plausible/claude.md \
...
mkdir -p ~/.codex
curl -fsSL https://raw.githubusercontent.com/ytimocin/agents/main/observability/plausible/codex.md \
  -o ~/.codex/AGENTS.md
...
```bash
mkdir -p .github
curl -fsSL https://raw.githubusercontent.com/ytimocin/agents/main/observability/plausible/copilot.md \
