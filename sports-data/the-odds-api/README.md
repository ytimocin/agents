...
curl -fsSL https://raw.githubusercontent.com/ytimocin/agents/main/sports-data/the-odds-api/claude.md \
...
mkdir -p ~/.codex
curl -fsSL https://raw.githubusercontent.com/ytimocin/agents/main/sports-data/the-odds-api/codex.md \
  -o ~/.codex/AGENTS.md
...
```bash
mkdir -p .github
curl -fsSL https://raw.githubusercontent.com/ytimocin/agents/main/sports-data/the-odds-api/copilot.md \
